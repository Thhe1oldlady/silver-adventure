...
class ChurnService:
    ...
    def _load_models(self):
        ...
        try:
            ...
            for model_name, filename in model_files.items():
                ...
                encoder_file = os.path.join(self.model_path, f"encoder_{model_name}.pkl")
    ...
    def _generate_sample_data(self) -> pd.DataFrame:
        ...
        data = {
            ...
            "contract_length": np.random.choice([1, 12, 24], n_samples, p=[0.5, 0.3, 0.2]),
    ...
    def _preprocess_data(self, df: pd.DataFrame, model_name: str, fit_preprocessors: bool = False) -> pd.DataFrame:
        ...
        categorical_columns = [
            ...
            "paperless_billing", "partner", "dependents", "phone_service", "multiple_lines"
        ]
                ...
                if fit_preprocessors:
                    ...
                    if model_name in self.encoders and col in self.encoders[model_name]:
                        ...
                        if unique_values - known_values:
                            ...
                            new_classes = list(le.classes_) + list(unique_values - known_values)
    ...
    async def train_model(self, model_type: str = "random_forest") -> Dict[str, Any]:
        ...
        try:
            ...
            if model_type == "random_forest":
                ...
                model = GradientBoostingClassifier(**self.model_config["gradient_boosting"])
            else:
            ...
            logger.info(f"Model {model_type} trained successfully with accuracy: {metrics['accuracy']:.3f}")
    ...
    async def predict_churn(self, customer_id: str, features: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Churn prediction failed for customer {customer_id}: {str(e)}")
    ...
    def get_pipeline_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for model_name in self.models.keys():
                metadata_file = os.path.join(self.model_path, f"metadata_{model_name}.json")
